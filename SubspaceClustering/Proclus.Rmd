...
df_proclus_k2_cluster1 <- df_noCorr[k2_cluster1,which(ProClus.clusters.k4[[1]][["subspace"]] == TRUE)]
df_proclus_k2_cluster2 <- df_noCorr[k2_cluster2,which(ProClus.clusters.k4[[2]][["subspace"]] == TRUE)]
df_proclus_k2_cluster3 <- df_noCorr[k2_cluster3,which(ProClus.clusters.k4[[3]][["subspace"]] == TRUE)]
df_proclus_k2_cluster4 <- df_noCorr[k2_cluster4,which(ProClus.clusters.k4[[4]][["subspace"]] == TRUE)]
