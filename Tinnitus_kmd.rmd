...
getKmeanslabels<-function(numClust){
  ...
  return(list("labels"=km_labels,"numClust"=numClust,"removeNA"=0))
}
...
gethKmeanslabels<-function(numClust){
  ...
  return(list("labels"=hkm_labels,"numClust"=numClust,"removeNA"=0))
}
...
gethierarchicallabels<-function(numClust){
  ...
  return(list("labels"=h_labels,"numClust"=numClust,"removeNA"=0))
}
...
getprocluslabels<-function(numClust){
  ...
  return(list("labels"=labels,"numClust"=numClust,"removeNA"=1))
}
 ...
 getorcluslabels<-function(numClust){
  ...
  return(list("labels"=ok_labels,"numClust"=numClust,"removeNA"=0))
}
...
getpcakmeanslabels<-function(numClust){
  ...
  return(list("labels"=pckm_labels,"numClust"=numClust,"removeNA"=0))
}
```
## User configuration
This chunk can be used for Configuration of different approaches. Function calls to get the cluster assignment of the approches.
```{r} 
  kmeansres<-getKmeanslabels(6)
  hierarchicalres<-gethierarchicallabels(6)
  hkmeansres<-gethKmeanslabels(4)
  proclusres<-getprocluslabels(5)
...
#kmeans
  ...
  #proclus
  cluster_plot_data<-getPlotData("proclus",proclusres$labels,proclusres$numClust)
   r2d3(data = cluster_plot_data[[1]], script = "cluster_chart.js",viewer ="internal")
   r2d3(data = cluster_plot_data[[2]], script = "cluster_chart.js",viewer ="internal")
...
##function call
 ...
 applyrf(kmeansres$labels,2,1000,5)
 applyrf(hierarchicalres$labels,2,1500,6)
 applyrf(hkmeansres$labels,2,1500,5)
 applyrf(orclusres$labels,2,1500,10)
 #applyrf(proclusres$labels,2,1000,5) 
 applyrf(pckmres$labels,2,1000,5)
```
