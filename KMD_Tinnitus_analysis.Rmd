...
initVis(pckm2_labels,num_clusters)
createDT(pckm2_labels,removeNA)
# applyrf(pckm2_labels,4,,)
...
initVis(pckm4_labels,num_clusters)
createDT(pckm4_labels,removeNA)
# applyrf(pckm2_labels,2,1500,5)
...
MatrixA <- matrix(, nrow = 1, ncol = 3)
MatrixA<-rbind(MatrixA,kmeans_result_2)
MatrixA<-rbind(MatrixA,hkmeans_result_2)
MatrixA<-rbind(MatrixA,hc_result_2)
MatrixA<-rbind(MatrixA,pcakmeans_result_2)
colnames(MatrixA)<-c("Dunn","Connectivity","Compactness")
MatrixA<-rbind(MatrixA,kmeans_result_4)
MatrixA<-rbind(MatrixA,hkmeans_result_4)
MatrixA<-rbind(MatrixA,hc_result_4)
MatrixA<-rbind(MatrixA,pcakmeans_result_4)
MatrixA<-MatrixA[-1,]
```