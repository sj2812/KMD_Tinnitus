...
# wss <- sapply(2:max_k, 
#               function(k){kmeans(scaled_df,k, nstart=1,iter.max = 15 )$tot.withinss})
wss
...
image(t(scaled_df)[, nrow(scaled_df):1],col = hcl.colors(5, "Spectral", rev = TRUE), yaxt = "n", xlab = "s", main = paste("Original Data"))
...
# plot(km.boot$result$result)
# km.boot
# km.boot$result$result
