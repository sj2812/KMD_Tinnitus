...
for(i in bootsamplesize){
  ...
  index <- sample(1:nrow(df_scaled_uncorr),nrow(df_scaled_uncorr),replace = T)
  
  #create samples from the index
  dfSample <-  df_scaled_uncorr[index,]
...
boxplot(totwss~k, data = wss.boot, xlab = "k", ylab = "totwss", main = "Bootsampled Data: Cluster withinss")
