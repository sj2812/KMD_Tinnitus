...
getPlotData<-function(algo_name,clus_name,final_labels,no_of_clusters)
{
...
cluster_features<-data.frame(df_allF_labeled%>%
                               ...
                               summarise_each(mean))
  clus_viz<-c()
  plotData<-createPlotData(algo_name,clus_name,cluster_features_scaled[1,],cluster_features[1,])
  return(plotData)
}
...
cluster_plot_data<-getPlotData("Hierarchical Clustering","Type 1",h2_labels,num_clusters)
